        ...
        <div class="pes-footer">
            ...
            <div class="links" data-testid="links">
                <?php if (empty($system['siteFooter'])): ?>
                    <a href="#" target="_blank" class="">广州格灵</a>
                    <a href="#" target="_blank" class="">使用帮助</a>
                    <a href="#" target="_blank" class="">软件协议</a>
                <?php else: ?>
                    <?= $system['siteFooter'] ?>
                <?php endif; ?>
                <span class="footer-line"></span>
				<a href="" target="_blank" class="am-link-success" >Power By 广州格灵</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $('header').before('<div class="am-alert am-alert-postscript am-text-sm am-margin-0 " data-am-alert style="position: fixed;width: 100%;bottom: 0px;z-index: 9999"><button type="button" class="close-f1 am-close">&times;</button><i class="am-icon-leanpub"></i> 按F1可以打开广州格灵帮助文档</div>')
    $('html, body').animate({scrollTop: 0}, '500');
    $('.close-f1').on('click', function () {
        confirm('请谨记按F1可随时打开广州格灵帮助文档。');
